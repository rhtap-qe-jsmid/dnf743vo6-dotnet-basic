...
export IMAGE_URL=${IMAGE_URL-quay.io/jsmid/rhtap-qe-dotnet-basic:$CI_TYPE-$TAG}
...
export GITOPS_REPO_URL=https://github.com/rhtap-qe-jsmid/dnf743vo6-dotnet-basic-gitops
